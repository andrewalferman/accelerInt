...
scons ATOL=1.0e-10 RTOL=1.0e-06 t_step=0.1 t_end=3000.0 SAME_IC=True mechanism_dir=examples/van_der_pol -j 4
touch timingdata-cvodes-vdp-ht.csv
touch timingdata-exp4-vdp-ht.csv
touch timingdata-exprb43-vdp-ht.csv
touch timingdata-radau2a-vdp-ht.csv
touch timingdata-rkc-vdp-ht.csv
./cvodes-int > timingdata-cvodes-vdp-ht.csv
./exp4-int > timingdata-exp4-vdp-ht.csv
./exprb43-int > timingdata-exprb43-vdp-ht.csv
./radau2a-int > timingdata-radau2a-vdp-ht.csv
./rkc-int > timingdata-rkc-vdp-ht.csv

scons t_step=0.1 t_end=320.0 mechanism_dir=examples/oregonator -j 4
touch timingdata-cvodes-oregonator-ht.csv
touch timingdata-exp4-oregonator-ht.csv
touch timingdata-exprb43-oregonator-ht.csv
touch timingdata-radau2a-oregonator-ht.csv
touch timingdata-rkc-oregonator-ht.csv
./cvodes-int > timingdata-cvodes-oregonator-ht.csv
./exp4-int > timingdata-exp4-oregonator-ht.csv
./exprb43-int > timingdata-exprb43-oregonator-ht.csv
./radau2a-int > timingdata-radau2a-oregonator-ht.csv
./rkc-int > timingdata-rkc-oregonator-ht.csv

scons t_step=1.0e-8 t_end=10.0 SAME_IC=True mechanism_dir=examples/csptest -j 4
touch timingdata-cvodes-csptest1-ht.csv
touch timingdata-exp4-csptest1-ht.csv
touch timingdata-exprb43-csptest1-ht.csv
touch timingdata-radau2a-csptest1-ht.csv
touch timingdata-rkc-csptest1-ht.csv
./cvodes-int > timingdata-cvodes-csptest1-ht.csv
./exp4-int > timingdata-exp4-csptest1-ht.csv
./exprb43-int > timingdata-exprb43-csptest1-ht.csv
./radau2a-int > timingdata-radau2a-csptest1-ht.csv
./rkc-int > timingdata-rkc-csptest1-ht.csv
...
scons t_step=1e-4 t_end=0.2 mechanism_dir=out/ -j 4
touch timingdata-cvodes-h2-ht.csv
touch timingdata-exp4-h2-ht.csv
touch timingdata-exprb43-h2-ht.csv
touch timingdata-radau2a-h2-ht.csv
touch timingdata-rkc-h2-ht.csv
./cvodes-int > timingdata-cvodes-h2-ht.csv
./exp4-int > timingdata-exp4-h2-ht.csv
./exprb43-int > timingdata-exprb43-h2-ht.csv
./radau2a-int > timingdata-radau2a-h2-ht.csv
./rkc-int > timingdata-rkc-h2-ht.csv
